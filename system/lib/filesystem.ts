...
This is a Mac OS 8 emulator built with modern web technologies.

Features:
- Complete Mac OS 8 Finder experience
- Draggable windows with authentic chrome
- Multiple concurrent applications
- Shareable app states via URLs
- Web3 integration (coming soon)
- Mobile responsive design

Created by Berry with ❤️

Explore the filesystem, open applications, and enjoy the nostalgia!`,
        },
        {
          id: 'doc-notes',
          name: 'My Notes',
