...
export function auctionForCard(data: Auction): AuctionCardDisplay {
  ...
  return {
    ...
    nounBackground: data.noun.seed.background,
    nounBody: data.noun.seed.body,
    nounAccessory: data.noun.seed.accessory,
    nounHead: data.noun.seed.head,
    nounGlasses: data.noun.seed.glasses,
  };
}
...
export function nounForCard(data: Noun): NounCardDisplay {
  return {
    ...
    background: data.seed.background,
    body: data.seed.body,
    accessory: data.seed.accessory,
    head: data.seed.head,
    glasses: data.seed.glasses,
