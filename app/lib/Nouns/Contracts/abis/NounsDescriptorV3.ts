/**
 * Nouns Descriptor V3 ABI
 * 
 * Contract: NounsDescriptorV3
 * Address: 0x33a9c445fb4fb21f2c030a6b2d3e2f12d017bfac
 * 
 * The Nouns Descriptor V3 contract generates Noun artwork and metadata.
 * It manages the trait parts (backgrounds, bodies, accessories, heads, glasses),
 * generates SVG images, and creates tokenURI data for Nouns NFTs.
 * 
 * Key functions:
 * - generateSVGImage: Generate SVG for a Noun seed
 * - tokenURI/dataURI: Generate token metadata
 * - backgrounds/bodies/accessories/heads/glasses: Get trait data
 * - addBackgrounds/addBodies/etc: Add new trait parts (owner only)
 * - getPartsForSeed: Get all parts for a given seed
 */
