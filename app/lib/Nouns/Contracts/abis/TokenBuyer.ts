 ...
 * 
 * The Token Buyer contract facilitates the conversion of ETH to payment tokens (USDC).
 * It manages treasury ETH sales, price feeds, and automated token purchasing with
 * configurable parameters for baseline amounts and bot discounts.
 * 
 * Key functions:
 * - buyETH: Purchase ETH with payment tokens
 * - ethAmountPerTokenAmount: Calculate ETH amount for token amount
 * - tokenAmountNeeded: Get amount of tokens needed for purchase
 * - price: Get current ETH/token price from price feed
 * - ethNeeded: Calculate ETH needed for additional tokens
 */
